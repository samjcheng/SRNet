...
parser.add_argument('--testpath', default='/DATA/i2r/guzw/dataset/dtu/dtu/dtu', help='testing data path')
...
parser.add_argument('--loadckpt', default='/DATA/i2r/guzw/workspace/StereoMatching/IGEV_SR/IGEV-MVS/checkpoints/SRnet_mvs/model_000009.ckpt', help='load a specific checkpoint')
...
if __name__ == '__main__':
    ...
    if args.dataset=="dtu_yao_eval":
        ...
        for scan in scans:
            ...
            save_file = os.path.join(args.outdir, 'igev_mvs{:0>3}_l3.ply'.format(scan_id))
            if os.path.exists(save_file):
                print("file: {} exists".format(save_file))
                continue
